...
class todo:
    def __init__(self, root):
        ...
        self.button = Button(self.root, text="Add", font='sarif, 20 bold italic', width=10,bd=5, bg="tomato", fg="black", command=add)
        self.button.place(x=30,y=180)

        self.button = Button(self.root, text="Delete", font='sarif, 20 bold italic', width=10,bd=5, bg="tomato", fg="black", command=delete)
