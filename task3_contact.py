...
class ContactManager:
    ...
    def setup_ui(self):
        # Title
        self.title = tk.Label(self.root, text="Contact Manager",bg='black', foreground='white' ,font=("Helvetica", 20))
        ...
        self.add_button = tk.Button(self.button_frame, text="Add Contact", background="orange",command=self.add_contact)
        self.add_button.grid(row=0, column=0, padx=5, pady=5)

        self.view_button = tk.Button(self.button_frame, text="View Contacts",background="orange", command=self.view_contacts)
        self.view_button.grid(row=0, column=1, padx=5, pady=5)

        self.search_button = tk.Button(self.button_frame, text="Search Contact",background="orange", command=self.search_contact)
        self.search_button.grid(row=0, column=2, padx=5, pady=5)

        self.update_button = tk.Button(self.button_frame, text="Update Contact",background="orange", command=self.update_contact)
        self.update_button.grid(row=0, column=3, padx=5, pady=5)

        self.delete_button = tk.Button(self.button_frame, text="Delete Contact",background="orange", command=self.delete_contact)
        self.delete_button.grid(row=0, column=4, padx=5, pady=5)

        self.clear_button = tk.Button(self.button_frame, text="Clear",background="orange", command=self.clear_entries)
